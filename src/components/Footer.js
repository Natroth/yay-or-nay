            ...
            <Container fluid={true}>
                <Row className="border-top justify-content-between p-3 footer">
                    ...
                    <Col className="d-flex justify-content-around bottom-links">
                        <a href="https://www.linkedin.com/in/nathan-roth-260b31187/" target="_blank"><FaLinkedin className="inner-link" /></a>
                        <a href="https://github.com/Natroth" target="_blank"><FaGithub className="inner-link" /></a>
                    </Col>
